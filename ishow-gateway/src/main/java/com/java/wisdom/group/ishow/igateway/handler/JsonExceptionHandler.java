...
/**
 * @author ：terry
 * @date ：Created in 2020/3/18 19:09
 * @description：TODO
 * @version: 1.0
 */
...
public class JsonExceptionHandler  implements ErrorWebExceptionHandler {
    ...
    public Mono<Void> handle(ServerWebExchange exchange, Throwable ex) {
        ...
        String code = httpStatus.toString().split(" ")[0];
        String msg = "{\"code\":" + code + ",\"message\": \"" + body + "\"}";
        result.put("body", msg);
        //ResponseDataUtil.error(httpStatus.toString().split(" ")[0],body);
        //错误记录
